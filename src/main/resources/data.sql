...
INSERT INTO form_prenotazione (id, tipo_attivita_id, data_inizio, data_fine, num_partecipanti, num_insegnanti)
VALUES (3, 2, '2023-03-10', '2023-03-15', 15, 3)
ON DUPLICATE KEY UPDATE tipo_attivita_id = VALUES(tipo_attivita_id), data_inizio = VALUES(data_inizio), data_fine = VALUES(data_fine), num_partecipanti = VALUES(num_partecipanti), num_insegnanti = VALUES(num_insegnanti);