/* -- Insert default records for age_group
...
-- Insert default records for activity_type
...
-- Insert default records for booking_duration
...
-- Insert default data for form_info
...
-- Insert default data for form_info_activity_type (join table)
...
-- Insert default data for form_booking
INSERT INTO form_booking (id, begin_time, end_time, participants_quantity, guides_quantity, booking_duration_id, booking_status)
VALUES (3, '2025-02-10', '2025-02-25', 15, 3, 1, 'PENDING')
ON DUPLICATE KEY UPDATE begin_time = VALUES(begin_time), end_time = VALUES(end_time), participants_quantity = VALUES(participants_quantity), guides_quantity = VALUES(guides_quantity), booking_duration_id = VALUES(booking_duration_id), booking_status = VALUES(booking_status);
...
-- Insert default data for admin_emails
